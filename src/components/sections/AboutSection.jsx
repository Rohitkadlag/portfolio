    ...
    >
      <div className="max-w-6xl w-full">
        ...
        >
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-gray-300 mb-12 md:mb-16 max-w-4xl leading-relaxed">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
            <StatCard number="2+" label="Years Experience" delay={0} isVisible={isVisible} />
            <StatCard number="18,000+" label="Data Points Processed" delay={100} isVisible={isVisible} />
            <StatCard number="40+" label="API Endpoints Built" delay={200} isVisible={isVisible} />
