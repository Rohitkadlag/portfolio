...
function ContactSection({ mousePosition }) {
  ...
  const contactMethods = [
    ...
    },
    {
      ...
      href: 'https://www.linkedin.com/in/rohit-kadlag-28ba1b201/',
      icon: (
  ...
  return (
    <section id="contact" className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 py-20 md:py-32 overflow-hidden">
      ...
      <div className="max-w-6xl w-full">
          ...
          {contactMethods.map((method, index) => (
            ...
            >
              ...
              <p className={`text-base font-medium transition-colors duration-300 ${
                ...
                {method.label}
                <svg className="inline-block w-4 h-4 ml-1 transition-transform duration-300 group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className={`text-center ${theme === 'dark' ? 'text-gray-500' : 'text-gray-600'} text-sm`}>
